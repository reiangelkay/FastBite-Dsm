...
|-------|-------------|-----|
| **Naranja Principal** | `#FF6B00` | Botones, logotipos y acentos principales. |
| **Naranja Oscuro** | `#A04100` | Estados de presión y detalles. |
| **Marrón Texto** | `#1C1B1B` | Títulos y texto principal. |
| **Marrón Suave** | `#5A4136` | Subtítulos y etiquetas secundarias. |
...
4. Asegúrate de tener configurado el archivo `google-services.json` para Firebase.
